...
class ReportPdfViewController: UIViewController {

    
    @IBOutlet weak var webView: WKWebView!
    @IBOutlet weak var ImagePrintPdf: UIImageView!
    let htmlstring = ReportsViewController.report_html!
    ...
    override func viewDidLoad() {
        ...
        ReportPdfViewController.modifiedStringHtml  = htmlstring.replacingOccurrences(of: "file:///android_asset/pflogo.png", with: HtmlImageBase64String)
       
        webView.loadHTMLString(ReportPdfViewController.modifiedStringHtml, baseURL: nil)
